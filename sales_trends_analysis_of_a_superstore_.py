...
# Project: Sales Trends Analysis of Superstore Dataset - Week 1
...
# This dataset havsnon utf-8 characeters so we will use latin1 to handle it.
import zipfile
...
# As mentioned earlier there is no null values in Dataset.
